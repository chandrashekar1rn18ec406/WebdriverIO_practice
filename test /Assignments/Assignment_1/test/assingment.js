describe("check if an input string is present in any of the cells", async () => {
  it("TC001", async () => {
    ...
    for (i = 0; i < (await tableData.length); i++) {
      //Here take the string value and check its include or not if string is matches print True and take screenshot.
    ...
    // if the value of i= tableData.length its print false
